...
class CardBag extends Component {
  Minus = () => {
    ...
    if (this.props.qty !== 1) {
      ...
      Alert.alert('Remove Item', 'Delete from bag?', [
  ...
  render() {
    ...
    return (
      <View style={styles.container} key={productId}>
        <Image
          source={{uri: BASE_URL + img, width: vw(23), height: vw(23)}}
          style={styles.img}
        />
        <View style={styles.infobag}>
          ...
          <View
            ...
            <View style={styles.price}>
              <Text
                numberOfLines={1}
                style={{fontFamily: 'Metropolis-Bold', fontSize: 20}}>
                Rp {this.toPrice(qty * price)}
              </Text>
            </View>
          </View>
        </View>
