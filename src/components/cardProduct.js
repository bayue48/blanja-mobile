...
class CardBag extends Component {
  ...
  deleteItems = () => {
    ...
    axios
      .delete(BASE_URL + '/product/deleteProduct/' + this.props.id, config)
      .then(({data}) => {
    ...
    return (
      <>
        <View style={styles.container}>
          <Image
            source={{uri: BASE_URL + image, width: vw(35), height: 128}}
            style={styles.img}
          />
