...
export default class navBottom extends React.Component {
    render() {
        ...
        if (this.props.home) {
            homeBtn =
                <>
                    <Image source={require('../assets/icons/homeAct.png')} style={{ width: 24, height: 24 }} />
        ...
        return (
            <>
                <View style={{ flexDirection: 'row', justifyContent: 'space-around', alignItems: 'center', backgroundColor: '#ededed', paddingTop: 5, paddingBottom: 5 }} >
                    ...
                    >
                        <View style={{ marginLeft: 20 }}>
                            <Image source={require('../assets/icons/fav.png')} style={{ width: 24, height: 24 }} />
