            ...
            <ScrollView vertical={true}>
                  ...
                  <ScrollView horizontal={true}>
                    {
                      productNew && productNew.map(({ id, product_name, product_price, product_category, product_img }) => {
                        ...
                        // console.log(img);
                        return (
                          <CardProduct id={id} name={product_name} price={product_price} category={product_category} image={img} navigation={this.props.navigation} />
                        )
                      })
                    }
              ...
              <Row size={4}>
                <SafeAreaView>
                  <ScrollView horizontal={true}>
                    {
                      products && products.map(({ id, product_name, product_price, product_category, product_img }) => {
                        let img = product_img.split(',')[0];
                        return (
                          <CardProduct id={id} name={product_name} price={product_price} category={product_category} image={img} navigation={this.props.navigation} />
                        )
