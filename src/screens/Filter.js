      ...
      <>
        <Container>
          <Header transparent>
            ...
            <Body>
              <Title
                style={{color: 'black', marginLeft: 40, fontWeight: 'bold'}}>
                Filters
              </Title>
            </Body>
          </Header>
          <Content style={{backgroundColor: '#f0f0f0'}}>
            ...
            <Text style={{fontWeight: 'bold', fontSize: 24, margin: 15}}>
              Color
            </Text>
