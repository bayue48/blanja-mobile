        ...
        return (
            <>
                <Container>
                    ...
                    {
                      products && products.map(({ id, product_name, product_price, product_category, product_size, product_color, product_img }) => {
                        let img = product_img.split(',')[0];
                        // console.log(img);
                        return (
                          <CardProduct id={id} name={product_name} price={product_price} category={product_category} size={product_size} color={product_color} image={img} navigation={this.props.navigation} />
                        )
                      })
                    }
