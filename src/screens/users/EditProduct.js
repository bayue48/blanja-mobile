...
class AddProduct extends React.Component {
    ...
    postProduct = () => {
        ...
        console.log(data);
        axios
            .patch(API_URL + `products/` + this.props.route.params.itemId, data, config)
            .then((data) => {
    ...
    render() {
        const { product_name, product_category, product_price, product_desc, product_img, product_brand, product_condition, product_qty } = this.state
                        ...
                        <View >
                            <Form>
                                ...
                                <Item floatingLabel>
                                    ...
                                    <Input name="product_brand" value={product_brand} onChangeText={(text) => { this.setState({ product_brand: text }) }} />
                                </Item>
                                <Item floatingLabel>
                                    <Label >Product QTY</Label>
                                    <Input name="product_qty" value={product_qty} onChangeText={(text) => { this.setState({ product_qty: text }) }} />
                                </Item>
                                <View style={styles.size}>
                                    ...
                                    >
                                        <Picker.Item label="Condition" value="0" style={{ color: 'gray' }} />
                                ...
                                <Item floatingLabel>
                                    <Label >Price</Label>
                                    <Input name="product_price" value={product_price} onChangeText={(text) => { this.setState({ product_price: text }) }} />
                                </Item>
