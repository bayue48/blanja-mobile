                    ...
                    <Content style={{ backgroundColor: '#f0f0f0', margin: 10 }}>
                        ...
                        <SafeAreaView>
                            <ScrollView style={{ height: 380, marginBottom: 20, marginTop: -20 }}>
                                ...
                                >
                                    {
                                        shippingAddress && shippingAddress.map(({ id, name, city, zip, phone }) => {
                                            return (
                                                <>
                                                    <TouchableOpacity
                                                        onPress={() => { this.setAddress(id) }}
                                                    >
                                                        <CardAdress key={id} addressId={id} name={name} city={city} postal={zip} phone={phone} navigation={this.props.navigation} />
                                                    </TouchableOpacity>
                                                </>
                                            )
                                        })
